...
<%
  final ComponentParameter nComponentParameter = RoleSelectUtils.get(request, response);
...
<div class="role_select">
  ...
  <div class="tb">
    <span class="icon"></span> <a class="chart"
      onclick="var act=$Actions['<%=name%>_chart']; act.a = this; act();"><%=RoleSelectUtils.getRoleChart(nComponentParameter)%></a>
  </div>
  <div class="ct">
  ...
  <div class="bottom">
    ...
    <div style="float: left;"><%=DictionaryRender.getActions(nComponentParameter)%></div>
  </div>
</div>
